...
void VentanaAplicacionFrm::CreateGUIControls()
{
    ...
    txtAreaRes = new wxTextCtrl(this, ID_TXTAREARES, wxEmptyString, wxPoint(363, 14), wxSize(359, 219), wxTE_MULTILINE, wxDefaultValidator, _("txtAreaRes"));
    txtAreaRes->SetMaxLength(0);
    txtAreaRes->Enable(false);
    txtAreaRes->SetFocus();
